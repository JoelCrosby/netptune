...
The development client runs on `http://localhost:6400`. The app launch profile uses `http://localhost:7400` and `https://localhost:7401`; the API profile uses `http://localhost:7500` and `https://localhost:7501`.
