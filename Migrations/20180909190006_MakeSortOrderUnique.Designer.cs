...
namespace DataPlane.Migrations
{
    ...
    [Migration("20180909190006_MakeSortOrderUnique")]
    partial class MakeSortOrderUnique
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataPlane.Models.Flag", b =>
                {
                    b.HasOne("DataPlane.Models.AppUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId");

                    b.HasOne("DataPlane.Models.AppUser", "DeletedByUser")
                        .WithMany()
                        .HasForeignKey("DeletedByUserId");

                    b.HasOne("DataPlane.Models.AppUser", "ModifiedByUser")
                        .WithMany()
                        .HasForeignKey("ModifiedByUserId");

                    b.HasOne("DataPlane.Models.AppUser", "Owner")
                        .WithMany()
