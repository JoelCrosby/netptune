...
export class ButtonLinkComponent {
  ...
  className = computed(() => {
    const base =
      'hover:bg-primary/20 min-h-[36px] inline-flex items-center justify-center gap-2 h-9 px-4 text-sm font-medium rounded-sm transition-colors cursor-pointer select-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50';
