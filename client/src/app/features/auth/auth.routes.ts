...
export const routes: Routes = [
  ...
  {
    path: 'confirm',
    loadComponent: () => import('./views/confirm-view/confirm-view.component').then((m) => m.ConfirmViewComponent),
    resolve: {
  ...
  },
  {
    ...
    loadComponent: () => import('./components/auth-provider/auth-provider.component').then((m) => m.AuthProviderComponent),
    resolve: {
