  ...
  template: `
    <button
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        role="img"
        aria-labelledby="a7qpw25exvox07kjj8aslcg42h7nzhd3"
        class="mr-4 fill-white text-white">
        <title id="a7qpw25exvox07kjj8aslcg42h7nzhd3">github</title>
        <path
      ...
      <span i18n="Button that starts sign-in via GitHub">
