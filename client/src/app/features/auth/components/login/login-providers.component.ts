  ...
  template: `
    ...
    <div class="grid grid-cols-3 gap-2.5">
      ...
      <button
        ...
        <span>{{ microsoftName }}</span>
      </button>
    </div>
  `,
})
export class LoginProvidersComponent {
  protected readonly githubName = 'GitHub';
  protected readonly googleName = 'Google';
  protected readonly microsoftName = 'Microsoft';

  protected readonly githubLabel = $localize`:Accessible label of the button that starts sign-in via GitHub:Continue with GitHub`;
  protected readonly googleLabel = $localize`:Accessible label of the button that starts sign-in via Google:Continue with Google`;
  protected readonly microsoftLabel = $localize`:Accessible label of the button that starts sign-in via Microsoft:Continue with Microsoft`;
