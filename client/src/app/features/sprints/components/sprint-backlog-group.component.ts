...
export class SprintBacklogGroupComponent {
  ...
  readonly data: DatatableDataSource<TaskViewModel> = {
    ...
    columns: [
      ...
      { id: 'status', header: 'Status', widthClass: 'w-32' },
      { id: 'priority', header: 'Priority', widthClass: 'w-20' },
      { id: 'projectName', header: 'Project', widthClass: 'w-32' },
      { id: 'assignees', header: 'Assignees', widthClass: 'w-28' },
