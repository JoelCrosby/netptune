  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { permission: PERMISSONS.workspace.read },
      ...
      },
      {
        path: 'tags',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.tags.read },
      ...
      },
      {
        path: 'tags/:id',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.tags.read, back: $localize`:Link back to the tag list from a single tag:Back to Tags` },
      ...
      },
      {
        path: 'statuses',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.statuses.read },
      ...
      },
      {
        path: 'statuses/:id',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.statuses.read, back: $localize`:Link back to the status list from a single status:Back to Statuses` },
      ...
      },
      {
        path: 'relations',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.relationTypes.read },
      ...
      },
      {
        path: 'relations/:id',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.relationTypes.read, back: $localize`:Link back to the relation type list from a single relation type:Back to Relations` },
      ...
      },
      {
        ...
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.serviceAccounts.read },
      ...
      },
      {
        path: 'data',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.tasks.export },
      ...
      },
      {
        path: 'data/export',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.tasks.export, back: $localize`:Link back to the data page from the export wizard:Back to Data` },
      ...
      },
      {
        path: 'data/import',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.tasks.import, back: $localize`:Link back to the data page from the import wizard:Back to Data` },
      ...
      },
      {
        path: 'data/archive',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.data.importArchive, back: $localize`:Link back to the data page from the archive import:Back to Data` },
      ...
      },
      {
        path: 'assistant',
        canActivate: [workspaceSettingsGuard],
        data: { permission: PERMISSONS.assistant.readAllConversations },
