...
@Component({
  ...
  template: `
    <div
      class="border-side-bar-border bg-side-bar custom-scroll z-10 flex h-full flex-col justify-between overflow-y-auto border-r [transition:width_.2s_ease-in-out]">
