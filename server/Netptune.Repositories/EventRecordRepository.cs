...
public class EventRecordRepository : Repository<DataContext, EventRecord, long>, IEventRecordRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new AuditLogDetailViewModel
        {
            ...
            UserIsServiceAccount = auditLog.UserIsServiceAccount,
        ...
        ActivityType activityType)
    {
        ...
        return activityType switch
        {
            ...
            ActivityType.ExportCompleted => ApplyCanonicalActivityFilter(query, EventKeys.ExportCompleted, legacyActivityType),
            ActivityType.ExportFailed => ApplyCanonicalActivityFilter(query, EventKeys.ExportFailed, legacyActivityType),
            ActivityType.ImportCompleted => ApplyCanonicalActivityFilter(query, EventKeys.ImportCompleted, legacyActivityType),
            ActivityType.ImportFailed => ApplyCanonicalActivityFilter(query, EventKeys.ImportFailed, legacyActivityType),
        ...
        CancellationToken cancellationToken)
    {
        ...
        return records.Select(record =>
        {
            ...
            return new AuditLogViewModel
            {
                ...
                UserIsServiceAccount = actor?.UserType == AppUserType.ServiceAccount,
                Agent = record.Agent,
                Type = activityType,
                EntityType = entityType,
