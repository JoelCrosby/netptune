-- Grants assistant.delete_any_conversations to existing admins and owners.
...
SET permissions = permissions || '["assistant.delete_any_conversations"]'::jsonb
WHERE role IN ('admin', 'owner')
  AND NOT permissions @> '["assistant.delete_any_conversations"]'::jsonb;
